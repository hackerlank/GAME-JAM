...
public class HelpScreen extends SerpScreen {
	...
	public HelpScreen(Game game) {
		super(game);
		Gdx.app.error("HelpScreen", "Constructor: super(game) job done!");
	...
	public HelpScreen(Game game, AssetManager assets) {
		super(game,assets);
		Gdx.app.error("HelpScreen", "Constructor: super(game,assets) job done!");
		...
		help1 = assets.get("help1.png", Texture.class);
	...
	public void render(float delta) {
		...
		spriteBatch.draw(help1, 64*ppuX, height - 100*ppuY - help1.getHeight()*ppuY,
				192*ppuX, 256*ppuY);
