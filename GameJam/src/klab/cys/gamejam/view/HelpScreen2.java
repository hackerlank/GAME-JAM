...
public class HelpScreen2 extends SerpScreen {
	...
	public HelpScreen2(Game game) {
		super(game);
		Gdx.app.error("HelpScreen2", "Constructor: super(game) job done!");
	...
	public HelpScreen2(Game game, AssetManager assets) {
		super(game,assets);
		Gdx.app.error("HelpScreen2", "Constructor: super(game,assets) job done!");
	...
	public void inputController() {
		if (Gdx.input.justTouched()){
			...
			if (inBounds(touchPos, 256*ppuX, 416*ppuY, 64*ppuX, 64*ppuY)){
				...
				if (this.assets != null)
					game.setScreen(new HelpScreen3(game,assets));
				return;
			}
		}
	}
